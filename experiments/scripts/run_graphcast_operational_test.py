...
def main():
    print("============================================================")
    print("GraphCastOperational one-step inference test")
    print("============================================================")
    ...
    zarr_path = output_dir / "graphcast_operational_test_20220101.zarr"

    if zarr_path.exists():
        raise FileExistsError(f"Output already exists: {zarr_path}")

    print("\nLoading GraphCastOperational package...")
    package = GraphCastOperational.load_default_package()
    print("Package loaded.")

    print("\nLoading GraphCastOperational model...")
    ...
    print("GraphCastOperational inference test finished successfully.")
