...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run FCN3 with WB2ERA5 input and extract station-level 10 m wind speed."
    )
    ...
    parser.add_argument(
        ...
        help="Start datetime. Must align with 6-hourly WB2ERA5 data.",
    )
    ...
    parser.add_argument(
        ...
        help="End datetime, inclusive. Must align with 6-hourly WB2ERA5 data.",
    )
...
def get_monthly_time_chunks(start: str, end: str) -> list[list[str]]:
    ...
    This avoids running the whole 2009-2012 period as one very large job.
    """
...
def main() -> None:
    ...
    print("============================================================")
    print("FCN3 ERA5 station wind prediction")
    print("============================================================")
    ...
    tmp_dir = output_dir / "tmp_fcn3_station_wind_raw"
    ...
    print("Loading WB2ERA5 data source...")
    print("Note: WB2ERA5 is 6-hourly ERA5 and valid before 2023-01-11.")
    ...
    for chunk_idx, times in enumerate(monthly_chunks, start=1):
        ...
        raw_zarr_path = tmp_dir / f"raw_fcn3_wb2era5_{month_tag}.zarr"
    ...
    combined.attrs["note"] = (
        ...
        "not full global forecast fields."
    )
